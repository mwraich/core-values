...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { card_id: @ranking.card_id, rating_id: @ranking.rating_id, selection_id: @ranking.selection_id } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { card_id: @ranking.card_id, rating_id: @ranking.rating_id, selection_id: @ranking.selection_id } }
